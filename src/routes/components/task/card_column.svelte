<script lang="ts">
    ...
    function handle_column_double_click(event: MouseEvent) {
        ...
        if (!(target instanceof Element) || target.closest("[data-task-card-surface]")) {
            return;
        }
        ...
        {#if !read_only}<ContextMenu.Content>
            ...
            <ContextMenu.Sub>
                ...
                <ContextMenu.SubContent>
                    ...
                    >
                        <ContextMenu.RadioItem value="custom">Custom</ContextMenu.RadioItem>
                        <ContextMenu.RadioItem value="due_date_asc">Due date: earliest first</ContextMenu.RadioItem>
                        <ContextMenu.RadioItem value="due_date_desc">Due date: latest first</ContextMenu.RadioItem>
                    </ContextMenu.RadioGroup>
                </ContextMenu.SubContent>
            </ContextMenu.Sub>
